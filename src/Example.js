...
import LoatLabelWrapper from "./LoatLabelWrapper";
...
const Example = (props) => {
  ...
  return (
    <div className="example">
      ...
      <LoatLabelWrapper label="Tree Select" name="lastName" value={treeValue}>
        <TreeSelect {...tProps} />
      </LoatLabelWrapper>
      <LoatLabelWrapper label="Select Option" name="name" value={selectValue}>
        <Select
          showSearch
          style={{ width: "100%" }}
